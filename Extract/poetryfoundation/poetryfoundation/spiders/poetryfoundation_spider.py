# -*- coding: utf-8 -*-
import scrapy
from poetryfoundation.items import PoemItem
import urlparse
import re
import scrapy
...
class poetryfoundationspider(scrapy.Spider):
    """
        This spider crawls poetryfoundation site and pipes poems to f_poems collection in mongodb poetry
        database
    """
    name = "poetryfoundationspider"
    allowed_domains = ["poetryfoundation.org"]
    start_urls = ["http://www.poetryfoundation.org/poetrymagazine"]
